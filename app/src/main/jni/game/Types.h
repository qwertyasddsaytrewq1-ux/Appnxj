...
#define STRIKER_PROPERTIES_PTR F(uintptr_t, libmain + O(0x2DEB610))

#define STRIKER_PROPERTIES_ENGLISH_MULTIPLIER F(double, STRIKER_PROPERTIES_PTR + 0x28)

#define STRIKER_PROPERTIES_MAX_POWER F(double, STRIKER_PROPERTIES_PTR + 0x30)
...
struct Instance {
    ...
    bool isInstanceOf(std::string className) { return instance != 0; }
...
struct FieldImpl<offset, T, true> : Instance {
